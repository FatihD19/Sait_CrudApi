        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 margin-tb">
                    <h2>Tutorial CRUD API Dengan AJAX JQuery PHP MySQL</h2>
                    ...
                    <a class="btn btn-primary" href="http://localhost/WebServiceRajaOngkir/" role="button">Web Service Raja Ongkir</a>
                    <br /><br />
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form data-toggle="validator" action="api/create.php" method="POST">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="user_address">Ekspedisi</label>
