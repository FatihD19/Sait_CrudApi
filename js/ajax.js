$( document ).ready(function() {
    ...
    // var url = "http://192.168.1.100/AjaxApi/";
    var url = "http://localhost/AjaxPhp/";
    var page = 1;
    var current_page = 1;
    var total_page = 0;
    var is_ajax_fire = 0;
    ...
    function manageRow(data) {
        ...
        // $.getJSON('http://localhost/FixApi/read.php', function(json) {
		// 		var tr=[];
		// 		for (var i = 0; i < json.length; i++) {
		// 			tr.push('<tr>');
		// 			tr.push('<td>' + json[i].user_name + '</td>');
		// 			tr.push('<td>' + json[i].user_email + '</td>');
        //             tr.push('<td>' + json[i].user_address + '</td>');
        //             tr.push('<td>' + json[i].user_id + '</td>');
		// 			tr.push('<button data-toggle="modal" data-target="#edit-user" class="btn btn-primary btn-sm edit-user"> <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Edit</button>');
		// 			tr.push('<button class="btn btn-danger btn-sm remove-user"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Hapus</button>');
        //             tr.push('</tr>');
        //             tr.push('</tr>');
		// 		}
